  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash the power of collective commuting with Car Sharing Application. Transforming the way you travel, one ride at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash the power of collective commuting with Car Sharing Application. Transforming the way you travel, one ride at a time.`}
            </Text>
            <Box
